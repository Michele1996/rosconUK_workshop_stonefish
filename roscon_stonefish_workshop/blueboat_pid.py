...
class BlueBoatPID(Node):
    ...
    def compute_command(self, x, y, yaw, dt):
        ...
        # TODO(participant):
        #  - stop when close to the goal
        #  - use distance_pid for surge
        #  - use heading_pid for yaw rate
        #  - reduce forward speed when the boat is pointing away from the goal
        #
        # Reference starter behaviour (intentionally incomplete):
        surge = 0.0
